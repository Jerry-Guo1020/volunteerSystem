...
CREATE TABLE IF NOT EXISTS signup (
    ...
    hours DOUBLE DEFAULT 0, -- 添加贡献小时数列
    FOREIGN KEY (user_id) REFERENCES user(id) ON DELETE CASCADE,
    FOREIGN KEY (project_id) REFERENCES project(id) ON DELETE CASCADE,
    UNIQUE (user_id, project_id) -- 确保同一个用户不会重复报名同一个项目
);
...
-- 添加更多生活用品示例数据（图片路径为本地image/xxx.jpg）
...
VALUES
('精美笔记本', '记录生活点滴，学习工作好帮手。', 180, 'image/notebook.jpg', FALSE),
('便携水杯', '健康饮水，随身携带。', 220, 'image/water.jpg', FALSE),
('创意书签', '让阅读更有趣。', 80, 'image/bookmark.jpg', FALSE),
('多功能笔', '一支笔满足多种书写需求。', 120, 'image/pen.jpg', FALSE),
('迷你手电筒', '小巧实用，应急照明。', 150, 'image/Flashlight.jpg', FALSE),
('卡通钥匙扣', '可爱造型，装饰你的钥匙。', 50, 'image/Keychain.jpg', FALSE),
('手机支架', '解放双手，追剧更轻松。', 100, 'image/222.jpg', FALSE),
('数据线收纳器', '告别杂乱，保持桌面整洁。', 70, 'image/111.jpg', FALSE);

-- 示例项目数据（含duration_hours）
INSERT INTO project (id, name, description, points, publisher, start_time, end_time, category, status, duration_hours) VALUES
(1, '社区清洁活动', '参与社区清洁，提升环境卫生。', 50, '社区中心', '2023-11-01 09:00:00', '2023-11-01 12:00:00', '环保', 1, 3),
(2, '图书馆志愿者', '协助图书馆整理书籍和管理借阅。', 30, '市图书馆', '2023-11-05 10:00:00', '2023-11-05 16:00:00', '教育', 1, 6),
(3, '老人院探访', '陪伴老人，提供关怀和帮助。', 40, '志愿者协会', '2023-11-10 14:00:00', '2023-11-10 17:00:00', '社区服务', 1, 3),
(4, '植树活动', '参与植树活动，绿化环境。', 60, '环保组织', '2023-11-15 08:00:00', '2023-11-15 11:00:00', '环保', 0, 3),
(5, '动物收容所志愿者', '帮助照顾动物，维护收容所环境。', 45, '动物保护协会', '2023-11-20 09:00:00', '2023-11-20 13:00:00', '动物保护', 1, 4);
